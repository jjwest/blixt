...
impl ::std::ops::Add for Value {
    type Output = Result<Value, failure::Error>;
    ...
    fn add(self, other: Value) -> Self::Output {
        ...
        match (self, other) {
            ...
            (Int32(_), Float32(_)) | (Float32(_), Int32(_)) => {
                Err(err_msg("Cannot add an integer with a float"))
            }
            (Int32(_), Bool(_)) | (Bool(_), Int32(_)) => {
                Err(err_msg("Cannot add an integer with a bool"))
            }
            (Float32(_), Bool(_)) | (Bool(_), Float32(_)) => {
                Err(err_msg("Cannot add a float with a bool"))
            }
...
impl ::std::ops::Sub for Value {
    ...
    fn sub(self, other: Value) -> Self::Output {
        ...
        match (self, other) {
            ...
            (Float32(a), Float32(b)) => Ok(Float32(a - b)),
            (Int32(_), Float32(_)) | (Float32(_), Int32(_)) => {
                Err(err_msg("Cannot subtract an int from a bool"))
            }
            (Int32(_), Bool(_)) | (Bool(_), Int32(_)) => {
                Err(err_msg("Cannot subtract an integer with a bool"))
            }
            (Float32(_), Bool(_)) | (Bool(_), Float32(_)) => {
                Err(err_msg("Cannot subtract a float with a bool"))
            }
...
impl ::std::ops::Mul for Value {
    ...
    fn mul(self, other: Value) -> Self::Output {
        ...
        match (self, other) {
            ...
            (Float32(a), Float32(b)) => Ok(Float32(a * b)),
            (Int32(_), Float32(_)) | (Float32(_), Int32(_)) => {
                Err(err_msg("Cannot multiply an int with a float"))
            }
            (Int32(_), Bool(_)) | (Bool(_), Int32(_)) => {
                Err(err_msg("Cannot multiply an integer with a bool"))
            }
            (Float32(_), Bool(_)) | (Bool(_), Float32(_)) => {
                Err(err_msg("Cannot multiply a float with a bool"))
            }
...
impl ::std::ops::Div for Value {
    ...
    fn div(self, other: Value) -> Self::Output {
        ...
        match (self, other) {
            ...
            (Float32(a), Float32(b)) => Ok(Float32(a / b)),
            (Int32(_), Float32(_)) | (Float32(_), Int32(_)) => {
                Err(err_msg("Cannot divide an int with a float"))
            }
            (Int32(_), Bool(_)) | (Bool(_), Int32(_)) => {
                Err(err_msg("Cannot divide an integer with a bool"))
            }
            (Float32(_), Bool(_)) | (Bool(_), Float32(_)) => {
                Err(err_msg("Cannot divide a float with a bool"))
            }
...
impl ::std::ops::Rem for Value {
    ...
    fn rem(self, other: Value) -> Self::Output {
        ...
        match (self, other) {
            ...
            (Float32(_), Bool(_)) | (Bool(_), Float32(_)) | (Bool(_), Bool(_)) => {
                Err(err_msg("Cannot use modulo with bools"))
            }
